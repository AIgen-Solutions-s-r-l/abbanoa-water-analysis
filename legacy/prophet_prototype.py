...
print("\n=== SUGGERIMENTI OPERATIVI ===")
print(
    f"1. Programmare manutenzioni nelle ore {hourly_pattern.nsmallest(3, 'mean').index.tolist()} (minimo consumo)"
)
print(f"2. Aumentare pressione/capacità nelle ore {peak_hours} (picco consumo)")
print(
    f"3. Considerare tariffe differenziate weekend (consumo -{(weekday_avg - weekend_avg)/weekday_avg * 100:.1f}%)"
)
