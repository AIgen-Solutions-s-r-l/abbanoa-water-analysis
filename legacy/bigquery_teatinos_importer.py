...
class TeatinoBigQueryImporter:
    ...
    def create_table_with_schema(self, schema_file):
        ...
        try:
            ...
            print(f"✅ Created table {self.project_id}.{self.dataset_id}.{self.table_id}")
            return table
        ...
        for check in checks:
            ...
            try:
                ...
                if len(result) == 1 and len(result.columns) == 1:
                    ...
                    print(f"   Result: {value:,}" if isinstance(value, (int, float)) else f"   Result: {value}")
                else:
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print(f"   🔗 Console: https://console.cloud.google.com/bigquery?project=abbanoa-464816")
