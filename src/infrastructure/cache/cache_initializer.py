...
class CacheInitializer:
    ...
    def _schedule_refresh(self) -> None:
        ...
        schedule.every().day.at("02:00").do(lambda: self._refresh_cache(full_refresh=True))
        
        logger.info(f"Scheduled cache refresh every {self.refresh_interval_hours} hours")
