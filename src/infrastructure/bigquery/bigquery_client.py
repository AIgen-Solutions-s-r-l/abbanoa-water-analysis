...
class BigQueryClient:
    ...
    def _create_client(self) -> Optional[bigquery.Client]:
        ...
        if credentials_path and os.path.exists(credentials_path) and os.path.getsize(credentials_path) > 0:
            try:
                ...
                print(f"BigQuery client created successfully with project: {self.project_id}")
                return client
