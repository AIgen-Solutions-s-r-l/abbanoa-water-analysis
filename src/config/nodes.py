...
ORIGINAL_NODES = {
    "sant_anna": NodeConfig(
        ...
        full_name="ROCCAVINA NODO VIA SANT ANNA",
    ...
    "seneca": NodeConfig(
        ...
        display_name="Seneca",
        full_name="ROCCAVINA NODO VIA SENECA",
        node_type="distribution",
        district="Roccavina",
        latitude=44.1298,
        longitude=12.2367
    ...
    "selargius_tank": NodeConfig(
        ...
        display_name="Roccavina Tank",
        full_name="ROCCAVINA SERBATOIO",
        node_type="storage",
        district="Roccavina",
        latitude=44.1342,
        longitude=12.2433
...
NEW_NODES = {
    "node_215542": NodeConfig(
        ...
        full_name="Roccavina Distribution 215542",
        node_type="distribution",
        district="Roccavina",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_215600": NodeConfig(
        ...
        full_name="Roccavina Distribution 215600",
        node_type="distribution",
        district="Roccavina",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_273933": NodeConfig(
        ...
        full_name="Roccavina Distribution 273933",
        node_type="distribution",
        district="Roccavina",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_281492": NodeConfig(
        ...
        full_name="Roccavina Monitoring 281492",
    ...
    "node_288399": NodeConfig(
        ...
        full_name="Roccavina Monitoring 288399",
        node_type="monitoring",
        district="Roccavina",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_288400": NodeConfig(
        ...
        full_name="Roccavina Monitoring 288400",
        node_type="monitoring",
        district="Roccavina",
        latitude=44.1278,
        longitude=12.2315
