...
ORIGINAL_NODES = {
    "sant_anna": NodeConfig(
        ...
        full_name="ABBANOA NODO VIA SANT ANNA",
    ...
    "seneca": NodeConfig(
        ...
        display_name="Seneca",
        full_name="ABBANOA NODO VIA SENECA",
        node_type="distribution",
        district="Abbanoa",
        latitude=44.1298,
        longitude=12.2367
    ...
    "selargius_tank": NodeConfig(
        ...
        display_name="Abbanoa Tank",
        full_name="ABBANOA SERBATOIO",
        node_type="storage",
        district="Abbanoa",
        latitude=44.1342,
        longitude=12.2433
...
NEW_NODES = {
    "node_215542": NodeConfig(
        ...
        full_name="Abbanoa Distribution 215542",
        node_type="distribution",
        district="Abbanoa",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_215600": NodeConfig(
        ...
        full_name="Abbanoa Distribution 215600",
        node_type="distribution",
        district="Abbanoa",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_273933": NodeConfig(
        ...
        full_name="Abbanoa Distribution 273933",
        node_type="distribution",
        district="Abbanoa",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_281492": NodeConfig(
        ...
        full_name="Abbanoa Monitoring 281492",
    ...
    "node_288399": NodeConfig(
        ...
        full_name="Abbanoa Monitoring 288399",
        node_type="monitoring",
        district="Abbanoa",
        latitude=44.1278,
        longitude=12.2315
    ...
    "node_288400": NodeConfig(
        ...
        full_name="Abbanoa Monitoring 288400",
        node_type="monitoring",
        district="Abbanoa",
        latitude=44.1278,
        longitude=12.2315
