...
class ProcessingService:
    ...
    async def initialize(self):
        ...
        await self.data_processor.initialize(self.postgres_manager, self.bigquery_client)
    ...
    async def _process_cycle(self):
        ...
        try:
            ...
            logger.info(f"Found new data: {new_data_info['record_count']} records from {new_data_info['min_timestamp']} to {new_data_info['max_timestamp']}")
            ...
            logger.info(f"Processing cycle completed successfully. Processed {processing_results['total_records']} records")
