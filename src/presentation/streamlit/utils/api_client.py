...
class APIClient:
    ...
    def _make_request(
        ...
        try:
            ...
            st.error(
                "Cannot connect to API server. Please ensure the processing services are running."
            )
            return None
    ...
    def get_node_metrics(
        _self, node_id: str, time_window: str = "1hour"
    ...
    def get_node_history(
        ...
        result = _self._make_request(
            "GET", f"/api/v1/nodes/{node_id}/history", params=params
        )
    ...
    def get_network_metrics(_self, time_range: str = "24h") -> Optional[Dict[str, Any]]:
        ...
        result = _self._make_request(
            "GET", "/api/v1/network/metrics", params={"time_range": time_range}
        )
        return result
    ...
    def get_network_efficiency(
        ...
        result = _self._make_request("GET", "/api/v1/network/efficiency", params=params)
        return result
    ...
    def get_predictions(
        ...
        result = _self._make_request(
            ...
            params={"model_type": model_type, "horizon_hours": horizon_hours},
        )
        return result or []
    ...
    def get_anomalies(
        ...
        result = _self._make_request("GET", "/api/v1/anomalies", params=params)
        return result or []

    @st.cache_data(ttl=60)
    def get_data_quality(_self, node_id: str) -> Optional[Dict[str, Any]]:
        """Get data quality metrics for a node."""
        result = _self._make_request("GET", f"/api/v1/quality/{node_id}")
        return result
