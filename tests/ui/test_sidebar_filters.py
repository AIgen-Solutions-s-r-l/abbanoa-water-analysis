...
class TestSidebarFilters:
    ...
    def test_render_calls_all_components(self, mock_markdown, mock_sidebar, sidebar_filters):
    ...
    def test_render_district_selector(self, mock_session_state, mock_selectbox, sidebar_filters):
    ...
    @patch('streamlit.selectbox')
    @patch('streamlit.session_state')
    def test_render_metric_selector(self, mock_session_state, mock_selectbox, sidebar_filters):
    ...
    @patch('streamlit.session_state')
    def test_render_horizon_selector(self, mock_session_state, mock_caption, mock_slider, sidebar_filters):
    ...
    def test_render_info_section(self, mock_columns, mock_metric, mock_markdown, mock_expander, sidebar_filters):
