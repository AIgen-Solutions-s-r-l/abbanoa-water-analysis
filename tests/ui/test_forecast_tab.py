...
class TestForecastTab:
    ...
    def test_render_metrics_cards(self, mock_columns, mock_info, mock_metric, forecast_tab):
    ...
    def test_error_handling(self, forecast_tab):
        ...
        with patch('streamlit.error') as mock_error:
            with patch('streamlit.session_state') as mock_state:
                ...
                forecast_tab.data_fetcher.get_forecast.side_effect = Exception("API Error")
