...
class TestWeatherAPIIntegration(unittest.TestCase):
    ...
    def test_weather_locations_returns_roccavina(self):
        """Test that /weather/locations returns only Roccavina."""
        # Arrange
        ...
        self.assertEqual(locations[0]['location'], 'Roccavina')
    ...
    def test_weather_current_returns_roccavina_data(self):
        """Test that /weather/current returns Roccavina weather data."""
        # Arrange
        ...
        self.assertEqual(weather['location'], 'Roccavina')
    ...
    def test_weather_historical_daily_returns_data(self):
        ...
        for record in historical_data:
            self.assertEqual(record['location'], 'Roccavina')
    ...
    def test_weather_historical_with_location_filter(self):
        ...
        # Verify all records are for Roccavina
        for record in historical_data:
            self.assertEqual(record['location'], 'Roccavina')
    
    def test_weather_statistics_returns_data(self):
        """Test that /weather/statistics returns data for Roccavina."""
        # Arrange
        url = f"{self.BASE_URL}/weather/statistics"
        params = {'location': 'Roccavina'}
