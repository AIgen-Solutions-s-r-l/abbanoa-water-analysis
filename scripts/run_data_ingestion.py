...
def ingest_selargius_data(service: BigQueryService, csv_path: str):
    ...
    service.load_dataframe(network_df, 'water_networks', write_disposition='WRITE_TRUNCATE')
    ...
    service.load_dataframe(nodes_df, 'monitoring_nodes', write_disposition='WRITE_TRUNCATE')
    ...
    for i in range(0, len(readings), batch_size):
        ...
        service.load_dataframe(readings_df, 'sensor_readings', write_disposition=disposition)
...
def main():
    ...
    # Ingest data
    csv_path = project_root / "RAWDATA" / "REPORT_NODI_SELARGIUS_AGGREGATI_30_MIN_20241113060000_20250331060000.csv"
