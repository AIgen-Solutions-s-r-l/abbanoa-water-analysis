...
def create_tables(client: bigquery.Client) -> None:
    ...
    monitoring_nodes_schema = [
        bigquery.SchemaField("id", "STRING", mode="REQUIRED", description="UUID primary key"),
        bigquery.SchemaField("network_id", "STRING", mode="REQUIRED", description="Foreign key to water_networks"),
        bigquery.SchemaField("name", "STRING", mode="REQUIRED"),
        bigquery.SchemaField("node_type", "STRING", mode="REQUIRED", description="SENSOR, PUMP, VALVE, TANK"),
    ...
    sensor_readings_schema = [
        bigquery.SchemaField("id", "STRING", mode="REQUIRED", description="UUID primary key"),
        bigquery.SchemaField("node_id", "STRING", mode="REQUIRED", description="Foreign key to monitoring_nodes"),
        bigquery.SchemaField("timestamp", "TIMESTAMP", mode="REQUIRED"),
        bigquery.SchemaField("temperature", "FLOAT", mode="NULLABLE", description="Temperature in Celsius"),
        bigquery.SchemaField("flow_rate", "FLOAT", mode="NULLABLE", description="Flow rate in L/s"),
        bigquery.SchemaField("pressure", "FLOAT", mode="NULLABLE", description="Pressure in bar"),
        bigquery.SchemaField("volume", "FLOAT", mode="NULLABLE", description="Volume in m³"),
        bigquery.SchemaField("is_anomalous", "BOOLEAN", mode="REQUIRED", field_type="BOOLEAN"),
        bigquery.SchemaField("created_at", "TIMESTAMP", mode="REQUIRED"),
        bigquery.SchemaField("updated_at", "TIMESTAMP", mode="REQUIRED"),
    ]
