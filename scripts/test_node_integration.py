...
def test_bigquery_data():
    ...
    try:
        ...
        if not df.empty:
            ...
            print(f"\nSample data:")
            print(df[['timestamp', 'node_id', 'flow_rate', 'pressure', 'data_quality_score']].head())
...
def test_dashboard_components():
    ...
    sidebar_path = project_root / "src/presentation/streamlit/components/sidebar_filters.py"
