#!/usr/bin/env python3
"""
SQLAlchemy server for PostgreSQL connection.
"""
...
app = FastAPI(title="SQLAlchemy PostgreSQL API")
...
@app.get("/")
async def root():
    return {"message": "SQLAlchemy PostgreSQL API is running!"}

@app.get("/api/v1/consumption/analytics")
async def get_consumption_analytics():
    """Get consumption analytics using SQLAlchemy."""
    try:
        # Use SQLAlchemy service
        database_url = "postgresql://abbanoa_user:abbanoa_dev_pass@localhost:5432/abbanoa_processing"
